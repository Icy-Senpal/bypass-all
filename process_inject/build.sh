...
export options="-Os -fPIC -fno-asynchronous-unwind-tables -fno-ident -fpack-struct=8 -falign-functions=1 -ffunction-sections -fdata-sections -Wl,--gc-sections -fomit-frame-pointer -s"
...
if [ -f "../../templates/helper_functions.template" ]; then
   ...
   print_info "Template file not found, using script_template.cna directly"
   cat ./script_template.cna > "${dist_directory}/processinject.cna"
fi
